...
const SummaryCard = ({
  ...
  return (
    <div className="summary-card flex items-center justify-between mb-4">
      ...
      <div className="summar-card-data flex flex-col justify-center items-center">
        <div className="flex">
          <div onClick={decrCartFunc} className="w-8 h-8 bg-[#000] cursor-pointer flex items-center justify-center rounded-lg">
        ...
        <div className="mt-2">
          <button
            onClick={removeCartFunc}
            className="bg-[#000] text-white px-4 py-1 rounded-md"
          >
            Remove
          </button>
        </div>
